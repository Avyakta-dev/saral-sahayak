...
- Image #11–#15: #11 L1 contract closed; #12+ still needs host/name agreement. Privacy #16–#20: #16 L1 approved/closed; #17+ implementation remains. Extension UI #21–#23: #21 Level 1 synthetic mocks are on `main` under `extension/mocks/privacy-ux-level-1/` (issue stays open until acceptance is evidenced). #22 has partial controls/preview/renderer UI (outbound-vs-local disclosure + fail-closed blocked/stale/unavailable terminal labels; Analyze/provider/first-last remain disabled; Chrome/Brave interactive evidence still not run); issue stays open. #23 a11y not started.
- Web UI #24–#26: #24 L1 mock UI closed; #48/#51/#57/#63/#69 landed live analyze, status UX, bounded retries and capabilities languages toward #25/#26. Capability-gated draft download wiring is in this frontend change (button hidden while `downloads_available` stays false). Remaining #25 honesty: reviewer acceptance that the real EPFO text flow + uncertainty UX is complete enough to close (no false ready draft). Preview merges do not by themselves close higher levels.
...
| Avyakta | [#22](https://github.com/iotserver24/saral-sahayak/issues/22) / [#21](https://github.com/iotserver24/saral-sahayak/issues/21) | Review partial UI Level 2 disclosure + blocked/stale fail-closed terminal UX toward #22 (keep issue open); #21 mocks remain labelled. Continue evidence/source gaps in #27–#28 as a separate knowledge track. Not Shravya's main web UI. |
