...
- Image #11–#15: #11 L1 contract closed; #12+ still needs host/name agreement. Privacy #16–#20: #16 L1 approved/closed; #17+ implementation remains. Extension UI #21–#23: #21 Level 1 synthetic mocks are on `main` under `extension/mocks/privacy-ux-level-1/` (issue stays open until acceptance is evidenced). #22–#23 integration/a11y not started.
...
| Avyakta | [#21](https://github.com/iotserver24/saral-sahayak/issues/21) | Accept/review #21 privacy UX mocks on `main` (`extension/mocks/privacy-ux-level-1/`), then wait for an explicit UI Level 2 request. Continue evidence/source gaps in #27–#28 as a separate knowledge track. Not Shravya's main web UI. |
