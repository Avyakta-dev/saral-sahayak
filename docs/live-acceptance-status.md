...
- Web UI #24–#26: #24 L1 mock UI closed; #48/#51/#57 landed live analyze + status UX toward #25. Remaining #25 honesty: bounded retries and draft-download-when-available (no false ready draft). Preview merges do not by themselves close higher levels.
...
| Shravya | [#25](https://github.com/iotserver24/saral-sahayak/issues/25) / [#26](https://github.com/iotserver24/saral-sahayak/issues/26) | Live analyze transport/status on `main` (#48/#51/#57); ship remaining #25 gaps (bounded retries; draft download only when available). Then Level 3 a11y/demo polish. Keep provider keys out of the frontend. |
